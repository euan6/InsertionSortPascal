...
randomize;
          ...
          begin
            insertionArray[loop].randomInsertionAsc:=random(1000)+1;
            insertionArray[loop].randomInsertionDesc:=random(1000)+1;
          end;
end;
...
var insertionArray:array[1..1000] of insertionNumbers;
